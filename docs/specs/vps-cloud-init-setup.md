...
- **AC8** — Die Setup-Vorlage ist **versioniert** (`TEMPLATE_VERSION`); nach S-151/S-152 ist die Version **v4** (v1 → v2: cloud-init-users-Sektion-Fix; v2 → v4: cloudflared-Docker-Container-Block). Tests prüfen die Bereiche stabil über die Version.
