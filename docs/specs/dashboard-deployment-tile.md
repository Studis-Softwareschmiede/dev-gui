...
- **AC9** (Paket ②, S-155 — Verweis) — Die über die Kachel geöffnete Deployments-Ansicht führt den Nutzer beim Deployen geführt per Dropdowns (Image/Tag/VPS/Domäne) statt per Freitext und bietet vor „Deploy auf VPS" ein „Lokal testen" an; das **Verhalten dieser Ansicht** ist in [[deploy-lifecycle]] (AC10–AC15) bzw. [[local-image-test]] spezifiziert — diese Kachel-Spec ändert daran **nichts** außer der Einstiegs-Affordanz (Kachel öffnet die Ansicht, AC3). Kein neuer Endpunkt, kein neues Secret im Bundle.
