 ...
 *
 * (workspace-path-config AC1 + UI-Anteil AC3 — seit #92 in SettingsView.test.jsx)
 *
 * NFR A11y (Clone-Teil):
 ...
 * POST /api/workspace/repos/pull, POST /api/workspace/repos/delete separat bedient.
 *
 ...
 *
 * (workspace-path-config Endpunkte liegen seit #92 in SettingsView.test.jsx)
 *
 * @param {{
...
describe('GitHubView — AC6: Graceful degradation (Repo-Liste)', () => {
  ...
  it('zeigt Fehler-Hinweis bei Netzwerkfehler (kein Crash/Whitescreen)', async () => {
    ...
    await waitFor(() => {
      ...
      // Mindestens ein Alert passt zum Repo-Ladefehler
