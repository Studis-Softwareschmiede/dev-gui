...
export function create({ deployOrchestrator, auditStore, vpsTargets, reconciliationJob, stackRegistry, stackDeployOrchestrator, localDockerControl, vpsRegistry, vpsDockerControl, cloudflareApi, tunnelHealService, bitwardenDeployAccessStore, bitwardenDeployLoginService, perAppGpgProvisioningService }) {
  ...
  combined.use(deploymentsRouter(deployOrchestrator, auditStore, vpsTargets, reconciliationJob, localDockerControl, vpsRegistry, vpsDockerControl, cloudflareApi, tunnelHealService, bitwardenDeployAccessStore, bitwardenDeployLoginService, perAppGpgProvisioningService));
