 ...
 *
 * obsidian-project-intake + obsidian-question-catalog (S-249, S-251 — dritte "Neues Projekt"-Option):
 *   Die `ObsidianImportSection`-Komponente (Verhaltens-Dokumentation siehe
 *   client/src/ObsidianImportSection.jsx) wird hier über `RepoList` gerendert;
 *   ihre Verhalten/Guards/beide Pfade bleiben unverändert seit Extraktion (S-300).
 *
  ...
  return (
    <>
      <section style={styles.section} aria-labelledby="repo-list-heading">
        ...
        {/* INTERIM: obsidian-project-intake AC2/AC3/AC5/AC6/AC7
            Sektion wird mit S-302 in den neuen "Neues Projekt"-Auswahl-Dialog (neues-projekt-auswahl-dialog.md)
            umgezogen und dort aus GitHubView.jsx entfernt. Aktuell bewusst noch hier gemountet als
            Zwischenschritt der Extraktion (S-300). S-302 hängt als Abhängigkeit an S-300 im Board. */}
...
const styles = {
  ...
  // ── Shared notice/error/empty-hint styles (RepoList AC6, WorkspaceOverview) ──
  notice: {
    padding: '12px 0',
    fontSize: 13,
    color: '#9ca3af',
