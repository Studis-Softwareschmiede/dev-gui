...
describe('routerLoader — Echte src/routers/ Module (AC1/AC3)', () => {
  ...
  it('genau 43 Router-Module in src/routers/ — Smoke-Assertion gegen versehentliche Löschung (AC1)', async () => {
    ...
    // notificationSettings.js wurde mit push-notifications (S-182) hinzugefügt
    ...
    // obsidianVaultPath.js wurde mit obsidian-vault-config (S-245) hinzugefügt
    ...
    // usage.js wurde mit der Token-Nutzungs-Anzeige ("goldene Münze") hinzugefügt
    //   (GET /api/usage — geschätzter Output-Token-Verbrauch Session/Woche) → 42.
    // repoSize.js wurde mit repo-size-badge (S-298) hinzugefügt
