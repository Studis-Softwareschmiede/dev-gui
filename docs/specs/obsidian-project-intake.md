...
> **Mount-Ort-Hinweis (2026-07-06):** Der **Einstiegspunkt** dieser Option wandert per [[neues-projekt-auswahl-dialog]] von der GitHub-„Neues Repo"-Sektion (`GitHubView.jsx`) auf den „Neues Projekt"-Auswahl-Dialog der **Fabrik-Übersicht**. Die nachfolgend beschriebenen **Verhaltens-/Guard-Kriterien (AC1–AC7) bleiben unverändert gültig** — nur der Ort, an dem die Option/`ObsidianImportSection` gerendert wird, ändert sich. Die Formulierung „neben +Neues Repo / Klonen" ist entsprechend als Mount-Ort **superseded**.
